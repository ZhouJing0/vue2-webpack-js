    ...
    Vue.directive('input', {
        inserted(el, binding, vnode) {
            ...
            function onlyFloat(input, n) {
                ...
                if (n) {//限制n位
                    var d = new Array(Number(n.float)).fill(`\\d`).join('');
                ...
                if (value.includes('-')) {
                    value =
                        value.indexOf(".") > 0
                            ? value.split(".")[0].substring(0, n.int + 1) + "." + value.split(".")[1]
                            : value.substring(0, n.int + 1);
                } else {
                    value =
                        value.indexOf(".") > 0
                            ? value.split(".")[0].substring(0, n.int) + "." + value.split(".")[1]
                            : value.substring(0, n.int);
                }
                input.value = value
            }
            //字母
