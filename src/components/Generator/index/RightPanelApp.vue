          ...
          <template v-if="activeData.__config__">
            ...
            <el-form-item
              ...
              v-if="
                ...
                !['easyframeText', 'card', 'groupTitle'].includes(activeData.__config__.easyframeKey)
              "
            >
            ...
            <template v-if="activeData.__config__.easyframeKey === 'comInput'">
            ...
            <template
              v-if="
                activeData.__config__.easyframeKey === 'numInput' || activeData.__config__.easyframeKey === 'slider'
              "
            >
            ...
            <template v-if="['radio', 'checkbox', 'select'].indexOf(activeData.__config__.easyframeKey) > -1">
              ...
              <easyframe-TreeSelect
                :options="treeData"
                v-model="activeData.__config__.dictionaryType"
                placeholder="选择数据字典"
                v-if="activeData.__config__.dataType === 'dictionary'"
                lastLevel
                clearable
              />
            ...
            <template
              v-if="
                activeData.__config__.easyframeKey === 'treeSelect' || activeData.__config__.easyframeKey === 'cascader'
              "
            >
              <el-form-item label="" label-width="40px">
                <el-radio-group
            ...
            <template v-if="activeData.__config__.easyframeKey === 'easyframeText'">
              <el-form-item label="文本内容">
                <el-input v-model="activeData.__config__.defaultValue" placeholder="请输入文本内容" />
              </el-form-item>
              <el-form-item label="行高">
                <el-input-number v-model="activeData.textStyle['line-height']" :min="12" placeholder="请输入行高" /> rpx
              </el-form-item>
              ...
              <el-form-item label="是否加粗">
                <el-switch v-model="activeData.textStyle['font-weight']" active-value="bold" inactive-value="normal" />
              </el-form-item>
              <el-form-item label="是否斜体">
                <el-switch v-model="activeData.textStyle['font-style']" active-value="italic" inactive-value="normal" />
              </el-form-item>
            ...
            <template v-if="activeData.__config__.easyframeKey === 'table'">
              <el-form-item label="关联子表" v-if="$store.getters.hasTable">
                ...
                >
                  <el-option v-for="item in subTable" :key="item.table" :label="item.table" :value="item.table">
                  </el-option>
                </el-select>
              </el-form-item>
            ...
            <template v-if="activeData.__config__.easyframeKey === 'groupTitle'">
...
export default {
  ...
  methods: {
    ...
    fieldChange(val) {
      ...
      const loop = list => {
        for (let i = 0; i < list.length; i++) {
          ...
          if (config && config.easyframeKey != 'table' && config.children && Array.isArray(config.children)) {
    ...
    dataTypeChange(val) {
      ...
      if (
        this.activeData.__config__.easyframeKey === 'treeSelect' ||
        this.activeData.__config__.easyframeKey === 'cascader'
      ) {
