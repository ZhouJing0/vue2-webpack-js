<template>
  <el-row>
    ...
    <el-form-item label="默认值">
      <el-checkbox-group v-model="activeData.__config__.defaultValue" :min="activeData.min" :max="activeData.max">
        <el-checkbox
          :label="item[activeData.__config__.props.value]"
          v-for="(item, i) in activeData.__slot__.options"
          :key="i"
        >
    ...
    <el-form-item v-if="activeData.__config__.optionType === 'button' || activeData.__config__.border" label="组件尺寸">
